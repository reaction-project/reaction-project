$(document).on("turbolinks:load", function() {
  ...
  $('[type=file][name="profile[avatar]"]').fileupload({
    add: function(e, data) {
      ...
      $.getJSON("/profile_avatars/cache/presign", options, function(result) {
    ...
    progress: function(e, data) {
      ...
      $('input[type="hidden"][name="profile[avatar]"]').val(JSON.stringify(image));
    }
  });
});
